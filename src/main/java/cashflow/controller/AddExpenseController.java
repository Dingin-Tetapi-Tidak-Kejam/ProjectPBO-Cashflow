...
public class AddExpenseController implements Initializable {
    ...
    // Mapping category → subcategory yang relevan
    private static final Map<ExpenseCategory, List<ExpenseSubCategory>> SUB_MAP = Map.of(
            ExpenseCategory.MAKANAN,   List.of(ExpenseSubCategory.SARAPAN, ExpenseSubCategory.MAKAN_SIANG,
                    ExpenseSubCategory.MAKAN_MALAM, ExpenseSubCategory.JAJAN),
            ExpenseCategory.TRANSPORT, List.of(ExpenseSubCategory.BENSIN, ExpenseSubCategory.GRAB,
                    ExpenseSubCategory.PARKIR),
            ExpenseCategory.BELANJA,   List.of(ExpenseSubCategory.PAKAIAN, ExpenseSubCategory.SKINCARE,
                    ExpenseSubCategory.ELEKTRONIK),
            ExpenseCategory.HIBURAN,   List.of(ExpenseSubCategory.BIOSKOP, ExpenseSubCategory.GAME,
                    ExpenseSubCategory.KONSER),
            ExpenseCategory.LAINNYA,   List.of(ExpenseSubCategory.LAINNYA)
    );
